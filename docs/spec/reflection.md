...
by character count; mail clients may wrap them visually without changing the
stored Inbox projection. Other frontends may define their own explicit
abbreviation policy without changing `ProvenanceService` output.
