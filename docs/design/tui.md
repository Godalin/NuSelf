...
- `docs/design/memory.md` explicitly names future interactive memory commands: `:mem`, `:mem last`, and `:mem why`.
- `src/nuself/cli/` exposes focused command and rendering modules that the REPL
  inspect layer should reuse.
